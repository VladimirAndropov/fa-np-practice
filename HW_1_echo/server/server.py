...
class Server:
    ...
    def router(self, conn, addr):
        ...
        # Продолжаем работать в цикле, пока соединение активно
        while True:
            ...
            # Ждем следующего сообщения от клиента
            logger.info(f"Ожидание следующего сообщения от клиента {client_ip}")
